    ...
    return (
        <div className="bg-white w-full flex items-center justify-center flex-col mt-5  md:mt-0">
            ...
            <div className="flex items-center justify-around flex-col md:flex-row">
                ...
                <div className="mr-32 md:mr-20 mb-20">
                    <div className="flex md:items-center items-center justify-center w-[490px] md:w-auto">
                            ...
                            <p className="text-[#2CBEE3] text-[20px] w-[300px] m-auto  mb-8  md:text-[40px] md:w-[600px] ">
                                Are you a programmer?
                            </p>
                            <Link href="/Products" className="w-[302px] md:w-[450px] h-[45px] rounded mt-3 bg-[#2CBEE3] flex items-center justify-center">
                                Developer
                            </Link>
                        </div>
                    </div>
