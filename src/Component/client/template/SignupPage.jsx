...
function SignupPage(props) {
    return (
        <div className="" style={{
            ...
            <div
                className="flex items-center md:items-start justify-center md:justify-start flex-col w-[350px] md:w-[592px] h-[686px] bg-white p-5 ml-16 top-60 mr-auto ml-auto md:ml-20 md:mr-0 md:right-0 relative md:top-16 border rounded-lg border-[#9D915F] ">
                <div>
