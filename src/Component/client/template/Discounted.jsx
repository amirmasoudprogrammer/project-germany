...
function Discounted() {
    ...
    return (
        <div className="relative w-full mx-auto h-screen  bg-white mt-16 md:mt-0 md:p-10  ">
            <div
                className="bg-custom-gradient w-[360px] m-auto md:w-full h-[600px] rounded-xl flex flex-col items-center justify-center md:p-6">
                <div>
                    <Image
                        src={`/image/“Discounted Price”.svg`}
                        alt="Discounted"
                        width={320}
                        height={84}
                        className="md:block"
